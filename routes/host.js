        ...
        const [result] = await db.query(
            `INSERT INTO tournaments 
             (tournament_name, tournament_description, host_user_id, game_mode, map_name, 
              ...
              registration_end, tournament_start_time, per_kill_reward, custom_rules, emulator_allowed,
              tournament_status)
            ...
            [
                ...
                registration_end, tournament_start_time, per_kill_reward || 0, custom_rules,
